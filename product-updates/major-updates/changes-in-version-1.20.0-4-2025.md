...
And one of the first big steps forward is the introduction of our [**beta** **AI Assistant**](https://app.gitbook.com/s/-MN4F4-qybg8XDATvios/ai-assistant), designed to help you build rules more easily—especially when you’re not sure where to start. Just describe your use case, and the assistant will guide you through the process.
