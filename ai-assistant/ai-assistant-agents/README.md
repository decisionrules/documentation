---
description: >-
  This page lists the agents available in the AI Assistant. Selected agents are
...
This section lists all agents available within the AI Assistant and explains their purpose, scope, and availability inside **DecisionRules**.

#### General Assistant Agent

**Availability:** All pages with the AI Assistant panel

This agent handles general conversation and broad assistance inside the platform. It is used when the request does not clearly belong to a more specialized agent.
...
This agent answers questions using the DecisionRules documentation. It searches the full DecisionRules Docs and returns concise answers based only on documented content.
...
If the documentation does not contain a clear answer, the agent states that explicitly instead of guessing.

#### Academy Search Agent

**Availability:** All pages with the AI Assistant panel

This agent helps users find relevant learning materials in DecisionRules Academy. It searches Academy courses, tutorials, and other educational content and recommends the most relevant results.
...
If the request is too broad, the agent may ask a clarifying question to narrow the search.

#### Navigation Helper Agent

**Availability:** All pages with the AI Assistant panel

This agent helps users find features and controls in the DecisionRules application.
...
#### Decision Table Architect Agent

**Availability:** Rules List

This agent generates a new Decision Table from natural-language instructions. It asks clarifying questions when required and then creates a structured table that matches the described logic.
...
#### Scripting Rule Architect Agent

**Availability:** Rules List, Scripting Rule Detail

This agent works with DecisionRules scripting rules.
...
If the requested scripting logic depends on existing rules, the agent can take folder and rule structure into account before generating references.

#### Generate Functions Agent

**Availability:** Decision Table Detail

This agent generates valid function expressions for selected cells in a Decision Table. It understands the cell context, including available variables, and uses DecisionRules function definitions correctly.
...
This agent helps users implement complex logic while maintaining correctness and readability.

#### Generate Test Data Agent

**Availability:** Decision Table Detail, Scripting Rule Detail

This agent generates input data for Decision Table evaluation. It supports both single and bulk generation and takes into account the table definition and the selected evaluation strategy.
...
#### Generate Rule Summary Agent

**Availability:** Decision Table Detail

This agent generates a human-readable summary of a Decision Table. For simple tables, the summary may describe the complete logic. For larger or more complex tables, it focuses on the main structure, conditions, and outcomes.
...
This agent improves understanding, reviews, and communication of decision logic without requiring readers to analyze the full table structure.

#### Templates Helper Agent

**Availability:** Rules List

This agent recommends DecisionRules templates based on the user’s described use case.
