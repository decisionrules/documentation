...
* **For Organization Owners / Admins**: Assigning the space to a Department is _optional_. An unassigned space remains a Global Space.
* **For Department Managers**: This step is _obligatory_ and scoped only to the department they manage.

[Policies](../policies.md) can be added to the newly created space in one step and access to the new space can be created directly. The creation of the space is confirmed by pressing the "Create" button. The newly created space appears in the list of all spaces.

<figure><img src="../../.gitbook/assets/CreateSpaceDialog.png" alt=""><figcaption><p>Add new spaces</p></figcaption></figure>
