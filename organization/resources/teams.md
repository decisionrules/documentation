...
&#x20;During creation, you will see a Department dropdown field.

* For Organization Owners / Admins: This field is _optional_. If left blank, the team becomes a Global Organization Team. If a department is selected, the team is created strictly inside that unit.
* For Department Managers: This field is _obligatory_ and automatically locked to your specific department.

<figure><img src="../../.gitbook/assets/Creating new team.png" alt=""><figcaption><p>Create new team - dialog</p></figcaption></figure>

### Update Teams

You can edit an existing team to change its name or color coding.

#### Relocating Teams (Admins/Owners Only)

Organization Owners and Admins can change a team's Department field to shift its scope. This allows for:

* Centralizing: Pull a departmental team up to the Global Organization level for broader management.
* Delegating: Move a Global team into a specific Department to narrow its focus.
* Transferring: Seamlessly shift teams between different department branches.

<figure><img src="../../.gitbook/assets/TeamEditDialog.png" alt=""><figcaption></figcaption></figure>

### Delete Team

In Table layout by clicking on action button followed by "Remove" button.

<figure><img src="../../.gitbook/assets/Delete Team.png" alt=""><figcaption><p>Delete team</p></figcaption></figure>
