...
![IF block](../.gitbook/assets/tree\_add\_condition.png)
...
![AND & OR Tree conditions](../.gitbook/assets/tree\_if\_conditions.png)
...
{% hint style="info" %}
Again, to add the <mark style="color:green;background-color:green;">**order\_accepted**</mark> as a result, we have to set up this property in the [Input/Output Model](../decision-tables/input-and-output/) in Rule Settings. Our final Input/Output model is depicted below.
{% endhint %}

![Decision Tree Input & Output model](../.gitbook/assets/tree\_io\_model.png)

![Adding new result into the Tree](../.gitbook/assets/tree\_add\_result.png)
...
![Simple Tree with all types of blocks](../.gitbook/assets/tree\_complete.png)
...
{% hint style="info" %}
Possible operators are specified in [Operators](../decision-tables/operators/) section
{% endhint %}
...
Test Bench allows you to test your Decision Tree to ensure that the rule is evaluating correctly. More about using Test Bench you can find in [dedicated documentation section](../other/test-bench.md).
