...
{% hint style="info" %}
All integrations described here are used **inside** a flow — DecisionRules is the one making the connection. If you are looking for ways to call DecisionRules from your own application, see [SDK & Libraries](../sdk-and-libraries/).
{% endhint %}
