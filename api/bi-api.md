...
{% swagger src="../.gitbook/assets/audits.yaml" path="/audit/v2" method="get" %}
[audits.yaml](../.gitbook/assets/audits.yaml)
{% endswagger %}

{% swagger src="../.gitbook/assets/audits.yaml" path="/audit/v2/count" method="get" %}
[audits.yaml](../.gitbook/assets/audits.yaml)
{% endswagger %}

{% swagger src="../.gitbook/assets/audits.yaml" path="/audit" method="delete" %}
[audits.yaml](../.gitbook/assets/audits.yaml)
{% endswagger %}
